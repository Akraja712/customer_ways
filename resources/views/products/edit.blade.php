                ...
                <div class="form-group">
                    <br>
                        ...
                        <select name="product_type" class="form-control @error('product_type') is-invalid @enderror" id="profession">
                            ...
                            <option value='Road product' {{ old('product_type', $products->product_type) == 'Road product' ? 'selected' : '' }}>Road product</option>
                            <option value='Adventure product' {{ old('product_type', $products->product_type) == 'Adventure product' ? 'selected' : '' }}>Adventure product</option>
                            <option value='Explore Cities' {{ old('product_type', $products->product_type) == 'Explore Cities' ? 'selected' : '' }}>Explore Cities</option>
                            <option value='Airport Flyover' {{ old('product_type', $products->product_type) == 'Airport Flyover' ? 'selected' : '' }}>Airport Flyover</option>
                        </select>
                        @error('product_type')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
