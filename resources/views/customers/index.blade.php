...
@section('content-header', 'customers Management')
        ...
        <table class="table table-bordered table-hover">
            <thead class="thead-dark">
                <tr>
                    ...
                    <th>customer User Id <i class="fas fa-sort"></i></th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{$customer->id}}</td>
                    <td>
                        <a href="{{ asset('storage/app/public/users/' . $customer->user->profile) }}" data-lightbox="profile-{{ $customer->id }}">
                            <img class="customer-img img-thumbnail img-fluid rounded-circle" src="{{ asset('storage/app/public/users/' . $customer->user->profile) }}" alt="" style="max-width: 100px; max-height: 100px;">
                        </a>
                    </td>
                    <td>{{ optional($customer->user)->name }}</td> <!-- Display user name safely -->
                    <td>{{$customer->customer_user_id}}</td>
                    <td>{{ $customer->status == 1 ? 'Interested' : 'Not Interested' }}</td>
